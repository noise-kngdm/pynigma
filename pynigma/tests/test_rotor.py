...
init_vals = [[(x, (x + 1) % (constants.NUM_CHARS)) for x in range(constants.MIN_NUM, constants.NUM_CHARS)],
             [(x, (x + 5) % (constants.NUM_CHARS)) for x in range(constants.MIN_NUM, constants.NUM_CHARS)]
            ]
...
expected_map = [{0: 3, 1: 4, 2: 5, 3: 6, 4: 7, 5: 8, 6: 9, 7: 10, 8: 11, 9: 12, 10: 13,
                 11: 14, 12: 15, 13: 16, 14: 17, 15: 18, 16: 19, 17: 20, 18: 21, 19: 22, 20: 23,
                 21: 24, 22: 25, 23: 0, 24: 1, 25: 2},
                 
                {0: 18, 1: 19, 2: 20, 3: 21, 4: 22, 5: 23, 6: 24, 7: 25, 8: 0, 9: 1, 10: 2,
                 11: 3, 12: 4, 13: 5, 14: 6, 15: 7, 16: 8, 17: 9, 18: 10, 19: 11, 20: 12,
                 21: 13, 22: 14, 23: 15, 24: 16, 25: 17
                }]
@pytest.mark.parametrize('test_list,ringstellung,expected_map', [(init_vals[0],ringstellung[0],expected_map[0]),
